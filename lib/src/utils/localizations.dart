...
class AppLocalizations {
  ...
  static const Map<String, String> _englishStrings = {
    ...
    'rateApp': 'Rate App',
    'rateAppMessage': 'If you enjoy using the app, please take a moment to rate it. Thanks for your support!',
...
**1. Introduction**
Welcome to Bling Azkar ("the App"). We are committed to protecting your privacy and ensuring you have a positive experience on our app. This Privacy Policy explains our practices regarding the collection, use, and disclosure of information.

**2. Information We Collect**
We do not collect any personal data or personally identifiable information (PII) from our users. All data generated by the App (such as settings, favorites, and tasbih counts) is stored locally on your device.

**3. Permissions**
The App may request the following permissions to function correctly:
*   **Notifications:** To send you scheduled reminders for Azkar and prayer times.
*   **Location:** To calculate accurate prayer times and determine the Qibla direction. Location data is processed locally on your device and is not transmitted to our servers.

**4. Third-Party Services**
The App may use third-party libraries for specific functionalities (e.g., prayer time calculation). These services are subject to their own privacy policies.
...
''',
  ...
  static const Map<String, String> _arabicStrings = {
    ...
    'rateApp': 'قيم التطبيق',
    'rateAppMessage': 'إذا كنت تستمتع باستخدام التطبيق، يرجى أخذ لحظة لتقييمه. شكراً لدعمك!',
    'privacyPolicyContent': '''
# سياسة الخصوصية
...
**1. مقدمة**
مرحبًا بك في تطبيق بلينج أذكار ("التطبيق"). نحن ملتزمون بحماية خصوصيتك وضمان حصولك على تجربة إيجابية في تطبيقنا. تشرح سياسة الخصوصية هذه ممارساتنا فيما يتعلق بجمع المعلومات واستخدامها والكشف عنها.

**2. المعلومات التي نجمعها**
نحن لا نجمع أي بيانات شخصية أو معلومات تحدد الهوية الشخصية (PII) من مستخدمينا. يتم تخزين جميع البيانات التي ينشئها التطبيق (مثل الإعدادات والمفضلة وعدادات التسبيح) محليًا على جهازك.

**3. الأذونات**
قد يطلب التطبيق الأذونات التالية ليعمل بشكل صحيح:
*   **الإشعارات:** لإرسال تذكيرات مجدولة للأذكار وأوقات الصلاة.
*   **الموقع:** لحساب أوقات الصلاة الدقيقة وتحديد اتجاه القبلة. تتم معالجة بيانات الموقع محليًا على جهازك ولا يتم إرسالها إلى خوادمنا.

**4. خدمات الطرف الثالث**
قد يستخدم التطبيق مكتبات تابعة لجهات خارجية لوظائف محددة (مثل حساب أوقات الصلاة). تخضع هذه الخدمات لسياسات الخصوصية الخاصة بها.
